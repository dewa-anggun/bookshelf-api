...
const addBookHandler = (request, h) => {
    ...
    const isSuccess = (name !== null) && (readPage <= pageCount);
...
const getAllBooksHandler = (request, h) => {
    ...
    if (name) {
        ...
        if (reading == 0 || reading == 1) {
            ...
            const filteredBook = books.filter((book) => book.reading == readingStatus)
                .map((book) => ({
                    id: book.id,
                    name: book.name,
                    publisher: book.publisher,
        ...
        if (finished == 0 || finished == 1) {
            ...
            const filteredBook = books.filter((book) => book.finished == finishedStatus)
                .map((book) => ({
                    id: book.id,
                    name: book.name,
                    publisher: book.publisher,
